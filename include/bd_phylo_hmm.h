...
typedef struct{
    ...
    int *state_to_branch;         /**< Mapping from states to branches on
                                   which birth/death/acc events occur */
